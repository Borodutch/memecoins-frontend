    ...
    <Wallet>
      <div className="container mx-auto max-w-prose p-10 prose">
        ...
        <p>
          ...
          link that you can send to fellow degens to mint as many of your coins
          as they can! And all the sweet (sweet) mint costs will go to the
          address you used to deploy! <b>AUTOMAGICALLY❗️ NANI???</b>
        </p>
        <h3>LFG 🚀</h3>
        <Form />
